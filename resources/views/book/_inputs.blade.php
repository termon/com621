...
<x-ui.form.input-group label="Title" name="title" value="{{ $book->title }}" class="mb-4" />
...
<x-ui.form.textarea-group label="Description" name="description" rows="8" value="{{ $book->description }}" class="mb-4"/>
