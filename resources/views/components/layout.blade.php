    ...
    <x-ui.nav class="justify-between items-center">
      ...
      <div class="flex gap-6 ">
        ...
        @auth
          ...
          <x-ui.nav.drop title="Manage">               
              
              <x-ui.nav.drop.item href="{{route('books.index')}}">              
                  <x-ui.svg.list/>
                  <span>Books</span>     
              </x-ui.nav.drop.item>             
                     
              <x-ui.nav.drop.item href="{{route('about')}}">
                  <x-ui.svg.info/>
                  <span>About</span> 
              </x-ui.nav.drop.item> 

              <x-ui.nav.drop.item href="{{route('home')}}">
                  <x-ui.svg.home/>
                  <span>Home</span>
              </x-ui.nav.drop.item>
