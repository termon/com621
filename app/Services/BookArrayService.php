...
class BookArrayRepository {
    ...
    public function all(): Collection
    {
        ...
        return collect(array_map(fn($r) => Book::fromArray($r), $records));
    }
    ...
    public function findOrFail(int $id): Book | \Exception
    {
        $record = $this->find($id);
        if ($record == null) {
    ...
    public function create(Book $record): Book
    {
        // load existing data
        $records = $this->all();
    ...
    public function update(int $id, Book $updated): ?Book
    {
